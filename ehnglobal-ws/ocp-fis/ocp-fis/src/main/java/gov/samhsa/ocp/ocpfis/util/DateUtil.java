...
public class DateUtil {
    ...
    public static Date convertStringToSimpleDateTime(String dateString) throws ParseException {
    ...
    public static Date convertIsoStringToDate(String dateString) throws DateTimeParseException  {
    ...
    /**
     * Returns true if endDateTime is after startDateTime or if startDateTime equals
     * endDateTime.
     * Returns false if either value is null. If equalOK, returns true if the
