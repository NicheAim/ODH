...
import gov.samhsa.ocp.ocpfis.service.exception.DriverLicenseSystemByStateNotFoundException;
...
public enum KnownIdentifierSystemEnum {
    ...
    DL("urn:oid:2.16.840.1.113883.4.3.0", "2.16.840.1.113883.4.3.0", "Driver's License", IdentifierTypeEnum.DL, Optional.empty()),
    MEDICAID_ID(IdentifierTypeEnum.MA.getmidurl(), IdentifierTypeEnum.MA.getmidurl(), "Medicaid ID", IdentifierTypeEnum.MA, Optional.empty()),
    /*
    ...
    */
    ...
    private static String mid = "url";

    private KnownIdentifierSystemEnum knownIdentifierSystemEnum;
