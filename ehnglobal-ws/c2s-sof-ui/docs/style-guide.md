# C2S-SOF UI Style Guide

*This C2S Smart On Fhir UI style guide is adopted from [Airbnb React/JSX Style Guide](https://github.com/airbnb/javascript/blob/master/react/README.md) with modifications as indicated.
