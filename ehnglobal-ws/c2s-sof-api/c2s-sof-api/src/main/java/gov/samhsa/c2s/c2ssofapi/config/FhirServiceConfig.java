...
public class FhirServiceConfig {
    ...
    public IGenericClient fhirClient() {
        ...
        System.out.println("FHIRSERVERURL: "+fhirServerUrl);
        ...
        final IGenericClient fhirClient = fhirContext().newRestfulGenericClient(configProperties.getFhir().getServerurl());
    ...
    public IParser fhirJsonParser() {
        System.out.println("fhirJsonParser");
        return fhirContext().newJsonParser();
    }

    @Bean
    public FhirValidator fhirValidator() {
        System.out.println("fhirValidator");
