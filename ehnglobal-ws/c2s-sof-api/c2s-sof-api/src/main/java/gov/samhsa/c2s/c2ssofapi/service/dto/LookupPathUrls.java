...
public enum LookupPathUrls {
    ...
    private static class Constants {
        static final String CONSENT_STATE_PATH = "/ValueSet/consent-state-codes";
        ...
        static final String CONSENT_SECURITY_ROLE_PATH = "/ValueSet/security-role-type";
        static final String CONSENT_ACTION_PATH = "/ValueSet/consent-action";
    }
}
