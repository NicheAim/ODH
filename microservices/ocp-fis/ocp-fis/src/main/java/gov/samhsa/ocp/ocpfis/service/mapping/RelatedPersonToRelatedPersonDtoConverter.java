...
public class RelatedPersonToRelatedPersonDtoConverter {
    ...
    public static RelatedPersonDto map(RelatedPerson relatedPerson) {
        ...
        //relationship
        if(relatedPerson.getRelationship().size() > 0){
            CodeableConcept relationshipCodeableConcept = relatedPerson.getRelationship().get(0);
        ...
        //name
        if (relatedPerson.getName() != null && relatedPerson.getName().size() > 0 && relatedPerson.getName().get(0) != null) {
