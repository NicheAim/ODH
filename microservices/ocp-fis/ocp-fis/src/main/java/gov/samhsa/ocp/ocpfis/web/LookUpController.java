...
public class LookUpController {
    ...
    @GetMapping("/conditions-patient")
    public List<ValueSetDto> getConditions() { return lookUpService.getConditions(); }

    @GetMapping("/conditions-priorities")
    public List<ValueSetDto> getConditionsPriorities() { return lookUpService.getConditionsPriorities(); }
