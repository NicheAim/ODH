...
public class HealthcareServiceServiceImplTest {
    ...
    public void testGetAllHealthcareServicesByLocation() {
        ...
        PowerMockito.when(PaginationUtil.getValidPageSize(fisProperties, java.util.Optional.ofNullable(size), org.hl7.fhir.r4.model.ResourceType.HealthcareService.name())).thenReturn(size);
        ...
        when(healthcareServiceResource.getResourceType()).thenReturn(org.hl7.fhir.r4.model.ResourceType.HealthcareService);
        ...
        when(locationPresent.getResourceType()).thenReturn(org.hl7.fhir.r4.model.ResourceType.Location);
