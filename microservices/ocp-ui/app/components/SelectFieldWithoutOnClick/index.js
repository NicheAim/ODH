...
function SelectFieldBridge(props) {
  const { field: { name, value }, form: { setFieldValue, errors }, children, ...rest } = props;
  return (
    <MUISelectField
      name={name}
      value={value}
...
function SelectFieldWithoutOnClick(props) {
...
SelectFieldWithoutOnClick.propTypes = {
  /**
...
SelectFieldWithoutOnClick.contextTypes = {
  /**
...
export default SelectFieldWithoutOnClick;
